...
const model = computed(() => {
    ...
    const groups = [
        ...
        },
        {
            label: 'Operations',
            items: [
                item('Drivers', 'pi pi-fw pi-id-card', '/drivers', ['company', 'admin']),
                item('Vehicles', 'pi pi-fw pi-truck', '/vehicles', ['company', 'admin']),
                item('Insurance', 'pi pi-fw pi-shield', '/insurance-vehicles', ['company', 'admin']),
                item('Service Requests', 'pi pi-fw pi-file-edit', '/service-requests', ['company']),
                item('Clearing House', 'pi pi-fw pi-building-columns', '/clearing-house', ['company', 'admin']),
                item('To-Do', 'pi pi-fw pi-check-square', '/todo', ['driver', 'company', 'admin']),
                item('Documents', 'pi pi-fw pi-folder', '/documents', ['driver', 'company', 'admin']),
