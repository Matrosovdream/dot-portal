...
<div class="col-md-6 fv-row fv-plugins-icon-container">
    ...
    <input type="text" class="form-control form-control-soli" id="field-{{ $field['field']['slug'] }}" name="fields[{{ $field['field']['id'] }}]"
        value="">
</div>
...
<div class="col-md-6 fv-row fv-plugins-icon-container">
    ...
    <textarea class="form-control form-control-soli" id="field-{{ $field['field']['slug'] }}" name="fields[{{ $field['field']['id'] }}]"></textarea>
</div>
...
<div class="col-md-6 fv-row fv-plugins-icon-container">
    ...
    <input type="text" class="form-control form-control-soli datepicker" id="field-{{ $field['field']['slug'] }}" name="fields[{{ $field['field']['id'] }}]" value="">
</div>
...
<div class="mb-10 fv-row fv-plugins-icon-container">
    ...
    <input type="file" class="form-control form-control-soli" id="field-{{ $field['field']['slug'] }}" name="fields[{{ $field['field']['slug'] }}]">
</div>
        ...
        <div class="form-check">
            <label class="form-check" for="field-{{ $field['field']['slug'] }}-{{ $option['value'] }}">
                <input class="form-check" type="radio" value="{{ $option['value'] }}"
                    id="field-{{ $field['field']['slug'] }}-{{ $option['value'] }}" name="fields[{{ $field['field']['slug'] }}]"
...
<div class="mb-10 fv-row fv-plugins-icon-container">
    ...
    <div class="form-check">
        <input class="form-check w-75" type="checkbox" id="field-{{ $field['field']['slug'] }}"
