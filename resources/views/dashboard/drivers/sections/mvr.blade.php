<div class="card mb-5 mb-xl-10">
    ...
    <form id="kt_account_profile_details_form" class="form" method="POST"
        action="{{ route('dashboard.drivers.show.mvr.update', $driver['id']) }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-4 fv-row">
                    <input type="text" name="mvr_number" class="form-control form-control-lg form-control-solid"
                        placeholder="Number" value="{{ $driver['mvr']['mvr_number'] ?? '' }}" />
                </div>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-4 fv-row">
                    <input type="date" name="mvr_date" class="form-control form-control-lg form-control-solid datepicker"
                        placeholder="Number" value="{{ $driver['mvr']['mvr_date'] ?? '' }}" />
                </div>
