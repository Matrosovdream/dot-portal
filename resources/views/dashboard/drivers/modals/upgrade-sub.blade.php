...
<div class="modal fade" id="kt_modal_upgrade_sub_drivers" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body px-10 py-10">
                <p class="fs-5 text-gray-700 mb-5">
                    To add more drivers to your account, you'll need to upgrade your current subscription plan.
                </p>
