        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-body pt-15">
                ...
                <div class="d-flex flex-center flex-column mb-5">
                    <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1">{{ $driver['name'] }}</a>
                </div>
            ...
            <div class="tab-pane fade active show" id="kt_ecommerce_customer_general" role="tabpanel">
                <div class="card pt-4 mb-6 mb-xl-9">
                    ...
                    <div class="card-body pt-0 pb-5">
                        ...
                        <form class="form" method="POST" action="{{ route('dashboard.drivers.update', $driver['id']) }}" id="kt_ecommerce_customer_profile">
                            @csrf
