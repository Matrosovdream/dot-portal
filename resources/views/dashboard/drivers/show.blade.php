        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-body pt-15">
                ...
                <div class="d-flex flex-center flex-column mb-5">
                    ...
                    <a href="#" class="fs-5 fw-semibold text-muted text-hover-primary mb-6">{{ $service->email }}</a>
                </div>
            ...
            <div class="tab-pane fade active show" id="kt_ecommerce_customer_general" role="tabpanel">
                <div class="card pt-4 mb-6 mb-xl-9">
                    ...
                    <div class="card-body pt-0 pb-5">
                        ...
                        <form class="form" method="POST" action="{{ route('dashboard.services.update', $service->id) }}" id="kt_ecommerce_customer_profile">
                            @csrf
            ...
            <div class="tab-pane fade" id="kt_ecommerce_customer_advanced" role="tabpanel">
                <div class="card pt-4 mb-6 mb-xl-9">
                    ...
                    <div class="card-body pt-0 pb-5">
                        ...
                        <form class="form" method="POST" action="{{ route('dashboard.users.update', $service->id) }}" id="kt_ecommerce_customer_profile">
                            @csrf
