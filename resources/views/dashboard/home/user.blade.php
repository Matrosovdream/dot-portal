            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">25</span>
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-500">Drivers</span>
                        </div>
                    </div>
        ...
        <div class="col-sm-6 col-xl-2 mb-xl-10">
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">96</span>
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-500">Power units</span>
                        </div>
                    </div>
        ...
        <div class="col-sm-6 col-xl-2 mb-xl-10">
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">16</span>
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-500">Trailers</span>
                        </div>
                    </div>
